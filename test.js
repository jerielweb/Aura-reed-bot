...
async function runTest() {
  ...
  const testUrl = "https://www.instagram.com/reel/Da7-hhiqfcv/?igsi=YmRxODZ1NmJsc280";

  if (!IG_REGEX.test(testUrl)) {
    console.log("⚠️ El enlace de prueba no cumple con la expresión regular de Instagram, actualízalo para probar con uno real.");
    return;
  }
  ...
  try {
    console.log(`2️⃣ Probando la extracción completa con downloadInstagram()...`);

...
export default {
    ...
    description: 'Envía una reacción "highfive" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('highfive');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('chocó los cinco con') + ' ' + targetTag;
            } else {

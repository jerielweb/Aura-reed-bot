...
export default {
    ...
    description: 'Envía una reacción "smug" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('smug');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('mira con superioridad a') + ' ' + targetTag;
            } else {

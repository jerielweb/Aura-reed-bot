...
export default {
    ...
    description: 'Envía una reacción "thumbsup" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('thumbsup');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('le da un pulgar arriba a') + ' ' + targetTag;
            } else {

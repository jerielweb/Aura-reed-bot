...
export default {
    ...
    description: 'Envía una reacción "sad" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('sad');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('está triste por culpa de') + ' ' + targetTag;
            } else {

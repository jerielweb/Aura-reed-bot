...
export default {
    ...
    description: 'Envía una reacción "snuggle" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('snuggle');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('se acurruca amorosamente con') + ' ' + targetTag;
            } else {

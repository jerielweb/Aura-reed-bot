...
export default {
    ...
    description: 'Envía una reacción "blowkiss" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('blowkiss');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('le lanzó un beso a') + ' ' + targetTag;
            } else {

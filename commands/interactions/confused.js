...
export default {
    ...
    description: 'Envía una reacción "confused" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('confused');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('está confundido/a por') + ' ' + targetTag;
            } else {

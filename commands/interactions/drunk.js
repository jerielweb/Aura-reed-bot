...
export default {
    ...
    description: 'Envía una reacción "drunk" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('drunk');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('está borracho/a con') + ' ' + targetTag;
            } else {

...
export default {
    ...
    description: 'Envía una reacción "scared" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('scared');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('está asustado/a por') + ' ' + targetTag;
            } else {

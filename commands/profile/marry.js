...
export default {
  ...
  execute: async (
     ...
     * ============================================================
     * IMPORTANTE:
     * Resolver también al REMITENTE.
     *
     * Antes:
     *
     * jidRemitente -> jidNormalizedUser()
     *
     * Ahora:
     *
     * jidRemitente
     ...
     * jidNormalizedUser()
     *
     * Esto evita comparar un @lid contra un @s.whatsapp.net.
     * ============================================================
     */
    ...
    /*
     * Si este usuario es quien debe aceptar
     * una solicitud de matrimonio, primero
     * usamos pending.from.
     *
     * Esto tiene prioridad sobre ctx.participant.
     */
    ...
    /*
     * Si no encontró objetivo y ya está casado,
    ...
    /*
     * Resolver nuevamente el objetivo.
     * Esto permite que pending.from también
     * quede normalizado.
     */
    ...
    if (
      ...
      if (
        ...
        text +=
          `┃ > Esta solicitud no es de matrimonio.\n\n`;
      ...
      text +=
        `┃ @${normalizedSender.split("@")[0]} 💕 @${targetJid.split("@")[0]}\n`;
    ...
    if (user.marriedTo) {
      if (
        ...
        text +=
          `┃ > Ya estás casado/a con @${targetJid.split("@")[0]}.\n`;

        text +=
          `┃ > Usa *${prefix}divorce @${targetJid.split("@")[0]}* para solicitar divorcio.\n\n`;
    ...
    text +=
      `┃ @${normalizedSender.split("@")[0]} quiere casarse contigo.\n`;

    text +=
      `┃ @${targetJid.split("@")[0]} acepta con:\n`;

    text +=
      `┃ ➪ *${prefix}marry @${normalizedSender.split("@")[0]}*\n`;

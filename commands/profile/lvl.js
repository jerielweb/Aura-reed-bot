import { getProfileUser, calculateLevel, xpToNextLevel, resolveTargetJid } from '../../models/profileUtils.js';
...
export default {
    ...
    execute: async (socket, message, args, { db, jidRemitente }) => {
        ...
        await socket.sendMessage(remoteJid, { text, mentions: [targetJid] }, { quoted: message });
    }
};

...
export default {
  ...
  category: 'sticker',
  description: 'Combina dos emojis y los convierte en un sticker usando Emoji Kitchen.',
  ...
  execute: async (sock, message, args) => {
    ...
    const apis = [
      {
        ...
        request: () => axios.get('https://api.alyacore.xyz/tools/emojimix', {
          params: {
            emoji1,
            emoji2,
      ...
      },
      {
        ...
        request: () => axios.get('https://api.stellarwa.xyz/tools/emojimix', {
          params: {
            emoji1,
            emoji2,
            key: 'api-7C3jf'
    ...
    try {
      ...
      const outputPath = path.join(os.tmpdir(), `aura-emojimix-output-${tempId}.webp`)

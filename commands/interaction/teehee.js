...
export default {
    ...
    description: 'Envía una reacción "teehee" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('teehee');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('se ríe tímidamente de') + ' ' + targetTag;
            } else {

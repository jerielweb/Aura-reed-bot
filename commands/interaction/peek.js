...
export default {
    name: ['peek', 'asomarse', 'mirar', 'espiar', 'asomando'],
    category: 'interaction',
    description: 'Asomarse',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('peek');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('espía a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('está espiando 👀');
            }

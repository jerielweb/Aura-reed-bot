...
export default {
    name: ['bite', 'morder', 'mordisco', 'muerde', 'mordida', 'morderse'],
    category: 'interaction',
    description: 'Dar una Mordida',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('bite');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('mordió a') + ' @' + targetJid.split('@')[0];
            } else {

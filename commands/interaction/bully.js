...
export default {
    name: ['bully', 'molestar', 'intimidar', 'abusar', 'fastidiar', 'burlar'],
    category: 'interaction',
    description: 'Molestar a Alguien',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('bully');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('está molestando a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('se siente travieso/a 😈');
            }

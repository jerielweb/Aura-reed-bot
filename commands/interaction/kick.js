...
export default {
    name: ['patear', 'patada', 'patadas', 'patea', 'pateando'],
    category: 'interaction',
    description: 'Dar una Patada',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('kick');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('pateó a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('dio una patada al aire 👟');
            }

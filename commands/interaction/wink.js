...
export default {
    name: ['wink', 'guiñar', 'guiño', 'guiñando', 'guiñazo'],
    category: 'interaction',
    description: 'Guiñar un Ojo',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('wink');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('le guiña un ojo a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('guiña un ojo 😉');
            }

...
export default {
    name: ['drunk', 'borracho', 'borracha', 'ebrio', 'ebria', 'tomado', 'tomada', 'alcoholico', 'pedas'],
    ...
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('drunk');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('está borracho/a con') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('está borracho/a 🍻');
            }

...
export default {
    name: ['curious', 'curioso', 'curiosa', 'intriga', 'curiosidad', 'curiosear'],
    category: 'interaction',
    description: 'Estar Curioso/a',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('curious');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('siente curiosidad por') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('está curioso/a 🧐');
            }

...
export default {
    ...
    description: 'Envía una reacción "curious" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('curious');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('siente curiosidad por') + ' ' + targetTag;
            } else {

...
export default {
    name: ['pout', 'puchero', 'berrinche', 'enfurruñarse', 'pucheros'],
    category: 'interaction',
    description: 'Hacer Pucheros',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('pout');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('le hace puchero a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('hace puchero 😤');
            }

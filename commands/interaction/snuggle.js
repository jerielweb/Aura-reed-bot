...
export default {
    name: ['snuggle', 'acurrucarse', 'mimos', 'abrigar', 'acurrucadito'],
    category: 'interaction',
    description: 'Acurrucarse con Alguien',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('snuggle');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('se acurruca amorosamente con') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('quiere acurrucarse con alguien 🥰');
            }

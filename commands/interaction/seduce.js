...
export default {
    ...
    description: 'Envía una reacción "seduce" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('seduce');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('intenta seducir a') + ' ' + targetTag;
            } else {

...
export default {
    ...
    description: 'Envía una reacción "jump" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('jump');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('salta de alegría con') + ' ' + targetTag;
            } else {

...
export default {
    name: ['love', 'amar', 'amor', 'teamoteamo', 'amando', 'teamo'],
    category: 'interaction',
    description: 'Expresar Amor',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('love');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('le demuestra su amor a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('está enamorado/a ❤️');
            }

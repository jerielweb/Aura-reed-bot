...
export default {
    name: ['salute', 'saludar', 'respeto', 'saludo militar', 'firmes', 'saludando'],
    category: 'interaction',
    description: 'Hacer Saludo Militar',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('salute');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('saluda militarmente a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('hace un saludo militar 🫡');
            }

...
export default {
    ...
    description: 'Envía una reacción "salute" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('salute');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('saluda militarmente a') + ' ' + targetTag;
            } else {

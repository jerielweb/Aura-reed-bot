...
export default {
    name: ['sad', 'triste', 'tristeza', 'deprimido', 'deprimida', 'bajon'],
    category: 'interaction',
    description: 'Estar Triste',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('sad');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('está triste por culpa de') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('está triste 🥺');
            }

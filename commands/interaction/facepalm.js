...
export default {
    name: ['facepalm', 'palmada', 'decepcion', 'decepción', 'quepeo', 'cara'],
    category: 'interaction',
    description: 'Hacer Facepalm',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('facepalm');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('hace facepalm por') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('hace facepalm 🤦');
            }

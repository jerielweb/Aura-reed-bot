...
export default {
    ...
    description: 'Envía una reacción "tableflip" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('tableflip');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('voltea la mesa ante') + ' ' + targetTag;
            } else {

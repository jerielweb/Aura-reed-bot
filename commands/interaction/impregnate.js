...
export default {
    name: ['impregnate', 'embarazar', 'preñar', 'fecundar', 'embarazo'],
    category: 'interaction',
    description: 'Embarazar',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('impregnate');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('embarazó a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('quiere embarazar a alguien 🤰');
            }

...
export default {
    ...
    description: 'Envía una reacción "impregnate" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('impregnate');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('embarazó a') + ' ' + targetTag;
            } else {

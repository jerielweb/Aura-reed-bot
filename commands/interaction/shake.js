...
export default {
    name: ['shake', 'temblar', 'sacudir', 'agitar', 'sacudiéndose'],
    category: 'interaction',
    description: 'Sacudir o Temblar',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('shake');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('sacude a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('se está sacudiendo 🫨');
            }

...
export default {
  name: ["lappillow", "regazo", "almohadamuslo", "recostarse", "muslos"],
  category: "interaction",
  description: "Recostarse en el Regazo",
    ...
    try {
      ...
      if (targetJid && targetJid !== jidRemitente) {
        ...
        caption =
          senderTag +
          " " +
          fytBold("se recuesta en el regazo de") +
          " @" +
          targetJid.split("@")[0];
      } else {
        caption =
          senderTag + " " + fytBold("quiere recostarse en un regazo 🥺");
      }

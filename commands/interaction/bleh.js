...
export default {
    ...
    description: 'Envía una reacción "bleh" en formato GIF animado.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('bleh');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('le hace bleh a') + ' @' + targetJid.split('@')[0];
            } else {

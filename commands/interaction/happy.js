...
export default {
    name: ['happy', 'feliz', 'alegre', 'felicidad', 'contento', 'contenta'],
    category: 'interaction',
    description: 'Estar Feliz',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('happy');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('está feliz por') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('está muy feliz 😄');
            }

...
export default {
    name: ['sniff', 'olfatear', 'oler', 'olisquear', 'snif'],
    category: 'interaction',
    description: 'Oler u Olfatear',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('sniff');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('olfatea a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('está olfateando 👃');
            }

...
export default {
    name: ['pat', 'acariciar', 'caricia', 'mimos', 'palmada', 'palmaditas'],
    category: 'interaction',
    description: 'Acariciar la Cabeza',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('pat');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('acaricia la cabeza de') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('quiere mimos/caricias 💆');
            }

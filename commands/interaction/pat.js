...
export default {
    ...
    description: 'Envía una reacción "pat" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('pat');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('acaricia la cabeza de') + ' ' + targetTag;
            } else {

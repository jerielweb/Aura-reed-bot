...
export default {
    name: ['punch', 'golpear', 'puñetazo', 'golpe', 'puño', 'pegar', 'trompazo'],
    category: 'interaction',
    description: 'Dar un Puñetazo',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('punch');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('le dio un puñetazo a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('da un golpe al aire 👊');
            }

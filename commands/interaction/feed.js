...
export default {
    ...
    description: 'Envía una reacción "feed" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('feed');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('está alimentando a') + ' ' + targetTag;
            } else {

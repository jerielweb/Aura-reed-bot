...
export default {
    ...
    description: 'Envía una reacción "kisscheek" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('kisscheek');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('le dio un beso en la mejilla a') + ' ' + targetTag;
            } else {

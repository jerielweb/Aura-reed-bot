...
export default {
    ...
    description: 'Envía una reacción "nom" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('nom');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('muerde cariñosamente a') + ' ' + targetTag;
            } else {

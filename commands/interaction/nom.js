...
export default {
    name: ['nom', 'masticar', 'comerse', 'morder', 'nomnom'],
    category: 'interaction',
    description: 'Masticar',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('nom');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('muerde cariñosamente a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('está comiendo algo rico 😋');
            }

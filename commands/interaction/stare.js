...
export default {
    ...
    description: 'Envía una reacción "stare" en formato GIF.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            const { image, mimetype } = await getReactionGif('stare');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('mira fijamente a') + ' ' + targetTag;
            } else {

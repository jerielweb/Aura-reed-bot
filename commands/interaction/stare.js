...
export default {
    name: ['stare', 'mirar', 'fijamente', 'mirada', 'observar'],
    category: 'interaction',
    description: 'Mirar Fijamente',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('stare');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('mira fijamente a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('mira fijamente 👁️_👁️');
            }

...
export default {
    name: ['push', 'empujar', 'empuje', 'empuja', 'empujando'],
    category: 'interaction',
    description: 'Empujar a Alguien',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('push');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('empujó a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('empuja el aire 🫷');
            }

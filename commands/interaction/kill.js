...
export default {
    name: ['kill', 'matar', 'asesinar', 'muerte', 'mata', 'matando'],
    category: 'interaction',
    description: 'Matar a Alguien',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('kill');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('mató a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('se auto-eliminó 💀');
            }

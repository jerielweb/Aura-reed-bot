...
export default {
    name: ['smug', 'presumido', 'presumida', 'arrogante', 'presumir', 'altivo'],
    category: 'interaction',
    description: 'Presumir',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('smug');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('mira con superioridad a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('sonríe con superioridad 😏');
            }

...
export default {
    name: ['thumbsup', 'pulgararriba', 'bien', 'aprobado', 'like'],
    category: 'interaction',
    description: 'Aprobar con el Pulgar',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('thumbsup');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('le da un pulgar arriba a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('da un pulgar arriba 👍');
            }

...
export default {
    name: ['scared', 'asustado', 'asustada', 'miedo', 'temblando', 'temor'],
    category: 'interaction',
    description: 'Estar Asustado/a',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('scared');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('está asustado/a por') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('está asustado/a 😨');
            }

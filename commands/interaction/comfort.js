...
export default {
    name: ['comfort', 'consolar', 'animar', 'apoyo', 'consuelo', 'consolando'],
    category: 'interaction',
    description: 'Consolar a Alguien',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('comfort');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('consuela a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('necesita consuelo 🥺');
            }

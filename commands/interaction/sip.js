...
export default {
    name: ['sip', 'sorbo', 'tomar', 'bebiendo', 'sorber', 'trago'],
    category: 'interaction',
    description: 'Tomar un Sorbo',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('sip');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('toma un sorbo con') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('está tomando un sorbo ☕');
            }

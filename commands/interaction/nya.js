...
export default {
    name: ['nya', 'miau', 'gato', 'gatito', 'maullar', 'nyan'],
    category: 'interaction',
    description: 'Hacer Nya',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('nya');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('le hace nya a') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('dice ¡nya! 🐱');
            }

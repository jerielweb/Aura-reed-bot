...
export default {
    ...
    description: 'Envía una reacción "shrug" en formato GIF animado.',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('shrug');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('se encoge de hombros ante') + ' @' + targetJid.split('@')[0];
            } else {

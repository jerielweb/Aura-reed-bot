...
export default {
    name: ['angry', 'enojado', 'enojada', 'enfado', 'furioso', 'furiosa', 'molesto', 'molesta', 'rabia', 'enojar'],
    category: 'interaction',
    description: 'Expresar Enojo',
    async execute(sock, m, args, { prefix, jidRemitente }) {
        ...
        try {
            ...
            const gifData = await getReactionGif('angry');
            ...
            if (targetJid && targetJid !== jidRemitente) {
                ...
                caption = senderTag + ' ' + fytBold('está enojado/a con') + ' @' + targetJid.split('@')[0];
            } else {
                caption = senderTag + ' ' + fytBold('está enojado/a 💢');
            }

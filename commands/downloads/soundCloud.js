...
async function searchTrackByQuery(query) {
    ...
    if (!results.length) throw new Error('No se encontraron resultados para tu búsqueda.');
...
export default {
    ...
    execute: async (socket, message, args) => {
        ...
        try {
            ...
            if (!mp3) throw new Error('Este track solo tiene stream HLS, no se puede descargar de forma progresiva');
